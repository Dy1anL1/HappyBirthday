...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('Hi 驰姐|祝你|生日快乐|Happy Birthday|打开声音|准备好了吗|3|2|1|#countdown 3||');
    }
...
S.ShapeBuilder = (function () {
  var gap = window.innerWidth < 768 ? 5 : 13,
  ...
  function fit() {
    gap = window.innerWidth < 768 ? 5 : 13;
  ...
  return {
    ...
    letter: function (l) {
      ...
      var maxFontSize = isMobile ? 250 : fontSize;

      setFontSize(maxFontSize);
      s = Math.min(maxFontSize,
        (shapeCanvas.width / shapeContext.measureText(l).width) * 0.8 * maxFontSize,
        (shapeCanvas.height / maxFontSize) * (isNumber(l) ? 1 : 0.45) * maxFontSize);
      setFontSize(s);
